        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
                <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-10 space-y-8">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">4. Listing and Housing Services</h2>
                        <p className="text-gray-600 leading-relaxed mb-3">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">5. Roommate Matching</h2>
                        <p className="text-gray-600 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">6. Messaging and Communication</h2>
                        <p className="text-gray-600 leading-relaxed mb-3">
                    ...
                    <section>
                        ...
                        <p className="text-gray-600 leading-relaxed mb-3">Users may not:</p>
                        <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">8. Content Ownership</h2>
                        <p className="text-gray-600 leading-relaxed">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">11. Account Termination</h2>
                        <p className="text-gray-600 leading-relaxed">
