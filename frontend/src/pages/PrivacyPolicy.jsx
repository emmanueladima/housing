            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
                <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-10 space-y-8">
                    ...
                    <section>
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mb-3 mt-4">2.1 Information You Provide</h3>
                        ...
                        <h3 className="text-lg font-semibold text-gray-800 mb-3 mt-4">2.2 Automatically Collected Information</h3>
                        <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-gray-900 mb-4">10. International Users</h2>
                        <p className="text-gray-600 leading-relaxed">
